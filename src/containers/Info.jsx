...
Hãy khám phá các khóa học của chúng tôi ngay hôm nay và bắt đầu hành trình của bạn để có được bằng lái xe!" />
            ...
            <div className="info-container">
                <Feature classNam="features-container__feature" title="Thời Gian" text={"Thời gian làm bài: " + typeGPLX.thoigianthi + " phút"} />
                <Feature classNam="features-container__feature" title="Số lượng" text={"Số lượng câu hỏi:" + typeGPLX.diemtoida + "câu."} />
                <Feature classNam="features-container__feature" title="Tổng Thể" text={"Số câu hỏi cần trả lời đúng:" + typeGPLX.diemtoitheu + "/" + typeGPLX.diemtoida + "câu là ĐẠT."} />
